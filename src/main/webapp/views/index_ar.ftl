...
<div style="margin:10px;">
	Today is ${.now?date} , contextPath is ${base} , messageSource(locale) is ${.locale} (<@spring.message "com.locale" />) .مرحبًا
</div>

<div id="accordion" style="float: right; width: 500px;">
...
<div id="blank" style="float: right; width: 10px;">&nbsp;</div>

<div id="join" style="float: right; width: 300px;">
